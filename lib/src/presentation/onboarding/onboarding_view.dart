...
class _OnboardingViewState extends ConsumerState<OnboardingView> {
  ...
  Future<void> _setupWhisper() async {
    ...
    try {
      ...
      final modelPath = await service.downloadDefaultModel(
        onProgress: (progress) {
          if (mounted) {
...
class _WhisperStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _OnboardingCard(
      ...
      subtitle:
          'MeetlyAI kann whisper-cli prüfen, auf macOS via Homebrew installieren und ein lokales Whisper-Modell herunterladen.',
